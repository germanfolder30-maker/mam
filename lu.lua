--[[
    ...
    Использует RemoteEvent: takeOutCrystal
]]
...
-- ========== INSTANT MINE (через takeOutCrystal) ==========
local REMOTE_NAME = "takeOutCrystal"    -- исправленное имя
...
local function instantLoopFunc()
    ...
    while states.instant do
        ...
        task.wait(0.02)  -- часто, чтобы шкала падала моментально
    end
end
...
print("✓ Меню готово. Instant Mine использует RemoteEvent 'takeOutCrystal'.")
