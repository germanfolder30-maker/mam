--[[
    БЕЛОЕ МЕНЮ С ФУНКЦИЯМИ ДЛЯ MINE A MOUNTAIN
    Кнопки: x2 Speed (рабочая), No Fall, x4 Backpack, Instant Mine, ???
...
local COLORS = {
    ...
    ToggleOn     = Color3.fromRGB(100, 200, 100),   -- зелёный для включенной функции
    ToggleOff    = Color3.fromRGB(200, 80, 80),    -- красный для выключенной
}

local FONT       = Enum.Font.GothamMedium
local FONT_BOLD  = Enum.Font.GothamBold

local WINDOW_SIZE_EXPANDED  = UDim2.fromOffset(300, 360)   -- чуть ниже, т.к. кнопок меньше
...
-- 4) Instant Mine (заглушка)
addToggleButton("⛏️", "Instant Mine", "instant", function(on)
    print("Instant Mine: " .. (on and "ON" or "OFF"))
end)

-- 5) Доп. кнопка (просто пример)
...
print("✓ Меню готово. x2 Speed работает, остальные кнопки ждут реализации.")
